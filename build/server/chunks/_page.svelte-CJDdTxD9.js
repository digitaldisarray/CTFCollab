...
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<!----> <span class="separator svelte-128j8gz">|</span></div> <header class="svelte-128j8gz"><h1 class="svelte-128j8gz">Welcome to CTF-Collab!</h1> <p class="svelte-128j8gz">To join an event, enter room code below or login with existing account</p> <div class="form-container svelte-128j8gz"><form class="flex w-full max-w-sm items-center space-x-2">`;
    Input($$payload2, {
      type: "room-code",
...
//# sourceMappingURL=_page.svelte-CJDdTxD9.js.map
